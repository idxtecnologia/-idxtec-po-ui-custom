...
export declare class PoTimePipe implements PipeTransform {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<PoTimePipe, never>;
    static ɵpipe: ɵngcc0.ɵɵPipeDeclaration<PoTimePipe, "po_time">;
}

//# sourceMappingURL=po-time.pipe.d.ts.map