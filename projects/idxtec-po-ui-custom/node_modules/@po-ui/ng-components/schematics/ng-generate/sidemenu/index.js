...
function default_1(options) {
    return schematics_1.chain([createAppComponent(options), module_1.addModuleImportToRootModule(options, routerModule, routerModulePath)]);
}
...
function createAppComponent(options) {
    return (tree) => {
        ...
        return schematics_1.chain([templateSource]);
    };
}
